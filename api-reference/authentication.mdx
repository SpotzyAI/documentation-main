...
The SpotzyAI API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your SpotzyAI account at [https://platform.spotzyai.com](https://platform.spotzyai.com)
...
```bash
curl -X GET "https://api.spotzyai.com/api/user/campaigns" \
