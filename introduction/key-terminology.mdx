...
icon: "book"
description: "Essential terms and concepts you need to know to use Spotzyai.com effectively"
---

Understanding these terms will help you navigate Spotzyai.com more easily:
...
Spotzyai.com's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with Spotzyai.com without renting new numbers.
