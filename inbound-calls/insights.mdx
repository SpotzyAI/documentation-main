...
After an inbound call, Spotzyai.com provides transcripts, analytics, and possible automation triggers.
...
- In your Spotzyai.com dashboard, go to **Calls** or **History**.
