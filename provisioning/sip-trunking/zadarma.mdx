...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is SpotzyAI SIP server address) .
...
## Step 2: Import numbers to SpotzyAI

You need to import to SpotzyAI.
...
For PBX Extension:
   ...
   <Frame>
     <img
       src="/resources/zadarma-spotzyai-type.png"
