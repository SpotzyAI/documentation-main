...
title: "SpotzyAI Tool"
icon: "phone"
description: "Learn how to use SpotzyAI triggers and actions in your AI calling flows"
---

# SpotzyAI Tool

The SpotzyAI tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the SpotzyAI tool prominently displayed at the top of the
...
![SpotzyAI Call Ended Trigger](/resources/spotzyai-trigger.jpg)
...
![SpotzyAI Action](/resources/spotzyai-action.jpg)
